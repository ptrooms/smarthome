 ...
 */
package org.eclipse.smarthome.model.rule.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import java.util.Map;
import org.eclipse.smarthome.model.rule.ide.contentassist.antlr.internal.InternalRulesParser;
...
public class RulesParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RulesGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRuleAccess().getNameAlternatives_1_0(), "rule__Rule__NameAlternatives_1_0");
			builder.put(grammarAccess.getEventTriggerAccess().getAlternatives(), "rule__EventTrigger__Alternatives");
			builder.put(grammarAccess.getEventEmittedTriggerAccess().getChannelAlternatives_1_0(), "rule__EventEmittedTrigger__ChannelAlternatives_1_0");
			builder.put(grammarAccess.getTimerTriggerAccess().getAlternatives(), "rule__TimerTrigger__Alternatives");
			builder.put(grammarAccess.getTimerTriggerAccess().getTimeAlternatives_1_2_0(), "rule__TimerTrigger__TimeAlternatives_1_2_0");
			builder.put(grammarAccess.getSystemTriggerAccess().getAlternatives(), "rule__SystemTrigger__Alternatives");
			builder.put(grammarAccess.getValidStateAccess().getAlternatives(), "rule__ValidState__Alternatives");
			builder.put(grammarAccess.getValidCommandAccess().getAlternatives(), "rule__ValidCommand__Alternatives");
			builder.put(grammarAccess.getValidTriggerAccess().getAlternatives(), "rule__ValidTrigger__Alternatives");
			builder.put(grammarAccess.getThingValidStateAccess().getAlternatives(), "rule__ThingValidState__Alternatives");
			builder.put(grammarAccess.getXLiteralAccess().getAlternatives(), "rule__XLiteral__Alternatives");
			builder.put(grammarAccess.getAbstractUnitAccess().getAlternatives(), "rule__AbstractUnit__Alternatives");
			builder.put(grammarAccess.getCOMMON_UNIT_SYMBOLSAccess().getAlternatives(), "rule__COMMON_UNIT_SYMBOLS__Alternatives");
			...
			builder.put(grammarAccess.getRuleModelAccess().getGroup(), "rule__RuleModel__Group__0");
			builder.put(grammarAccess.getVariableDeclarationAccess().getGroup(), "rule__VariableDeclaration__Group__0");
			builder.put(grammarAccess.getVariableDeclarationAccess().getGroup_1_0(), "rule__VariableDeclaration__Group_1_0__0");
			builder.put(grammarAccess.getVariableDeclarationAccess().getGroup_1_0_0(), "rule__VariableDeclaration__Group_1_0_0__0");
			...
			builder.put(grammarAccess.getCommandEventTriggerAccess().getGroup(), "rule__CommandEventTrigger__Group__0");
			builder.put(grammarAccess.getGroupMemberCommandEventTriggerAccess().getGroup(), "rule__GroupMemberCommandEventTrigger__Group__0");
			builder.put(grammarAccess.getUpdateEventTriggerAccess().getGroup(), "rule__UpdateEventTrigger__Group__0");
			builder.put(grammarAccess.getGroupMemberUpdateEventTriggerAccess().getGroup(), "rule__GroupMemberUpdateEventTrigger__Group__0");
			builder.put(grammarAccess.getChangedEventTriggerAccess().getGroup(), "rule__ChangedEventTrigger__Group__0");
			builder.put(grammarAccess.getChangedEventTriggerAccess().getGroup_3(), "rule__ChangedEventTrigger__Group_3__0");
			builder.put(grammarAccess.getChangedEventTriggerAccess().getGroup_4(), "rule__ChangedEventTrigger__Group_4__0");
			builder.put(grammarAccess.getGroupMemberChangedEventTriggerAccess().getGroup(), "rule__GroupMemberChangedEventTrigger__Group__0");
			builder.put(grammarAccess.getGroupMemberChangedEventTriggerAccess().getGroup_3(), "rule__GroupMemberChangedEventTrigger__Group_3__0");
			builder.put(grammarAccess.getGroupMemberChangedEventTriggerAccess().getGroup_4(), "rule__GroupMemberChangedEventTrigger__Group_4__0");
			builder.put(grammarAccess.getEventEmittedTriggerAccess().getGroup(), "rule__EventEmittedTrigger__Group__0");
			builder.put(grammarAccess.getTimerTriggerAccess().getGroup_0(), "rule__TimerTrigger__Group_0__0");
			builder.put(grammarAccess.getTimerTriggerAccess().getGroup_1(), "rule__TimerTrigger__Group_1__0");
			builder.put(grammarAccess.getSystemOnStartupTriggerAccess().getGroup(), "rule__SystemOnStartupTrigger__Group__0");
			builder.put(grammarAccess.getSystemOnShutdownTriggerAccess().getGroup(), "rule__SystemOnShutdownTrigger__Group__0");
			builder.put(grammarAccess.getThingStateUpdateEventTriggerAccess().getGroup(), "rule__ThingStateUpdateEventTrigger__Group__0");
			builder.put(grammarAccess.getThingStateChangedEventTriggerAccess().getGroup(), "rule__ThingStateChangedEventTrigger__Group__0");
			builder.put(grammarAccess.getThingStateChangedEventTriggerAccess().getGroup_3(), "rule__ThingStateChangedEventTrigger__Group_3__0");
			builder.put(grammarAccess.getThingStateChangedEventTriggerAccess().getGroup_4(), "rule__ThingStateChangedEventTrigger__Group_4__0");
			...
			builder.put(grammarAccess.getQuantityLiteralAccess().getGroup(), "rule__QuantityLiteral__Group__0");
			...
			builder.put(grammarAccess.getRuleModelAccess().getImportSectionAssignment_0(), "rule__RuleModel__ImportSectionAssignment_0");
			builder.put(grammarAccess.getRuleModelAccess().getVariablesAssignment_1(), "rule__RuleModel__VariablesAssignment_1");
			builder.put(grammarAccess.getRuleModelAccess().getRulesAssignment_2(), "rule__RuleModel__RulesAssignment_2");
			builder.put(grammarAccess.getVariableDeclarationAccess().getWriteableAssignment_0_0(), "rule__VariableDeclaration__WriteableAssignment_0_0");
			builder.put(grammarAccess.getVariableDeclarationAccess().getTypeAssignment_1_0_0_0(), "rule__VariableDeclaration__TypeAssignment_1_0_0_0");
			builder.put(grammarAccess.getVariableDeclarationAccess().getNameAssignment_1_0_0_1(), "rule__VariableDeclaration__NameAssignment_1_0_0_1");
			builder.put(grammarAccess.getVariableDeclarationAccess().getNameAssignment_1_1(), "rule__VariableDeclaration__NameAssignment_1_1");
			builder.put(grammarAccess.getVariableDeclarationAccess().getRightAssignment_2_1(), "rule__VariableDeclaration__RightAssignment_2_1");
			builder.put(grammarAccess.getRuleAccess().getNameAssignment_1(), "rule__Rule__NameAssignment_1");
			builder.put(grammarAccess.getRuleAccess().getEventtriggerAssignment_3(), "rule__Rule__EventtriggerAssignment_3");
			builder.put(grammarAccess.getRuleAccess().getEventtriggerAssignment_4_1(), "rule__Rule__EventtriggerAssignment_4_1");
			builder.put(grammarAccess.getRuleAccess().getScriptAssignment_6(), "rule__Rule__ScriptAssignment_6");
			builder.put(grammarAccess.getCommandEventTriggerAccess().getItemAssignment_1(), "rule__CommandEventTrigger__ItemAssignment_1");
			builder.put(grammarAccess.getCommandEventTriggerAccess().getCommandAssignment_3(), "rule__CommandEventTrigger__CommandAssignment_3");
			builder.put(grammarAccess.getGroupMemberCommandEventTriggerAccess().getGroupAssignment_1(), "rule__GroupMemberCommandEventTrigger__GroupAssignment_1");
			builder.put(grammarAccess.getGroupMemberCommandEventTriggerAccess().getCommandAssignment_3(), "rule__GroupMemberCommandEventTrigger__CommandAssignment_3");
			builder.put(grammarAccess.getUpdateEventTriggerAccess().getItemAssignment_1(), "rule__UpdateEventTrigger__ItemAssignment_1");
			builder.put(grammarAccess.getUpdateEventTriggerAccess().getStateAssignment_3(), "rule__UpdateEventTrigger__StateAssignment_3");
			builder.put(grammarAccess.getGroupMemberUpdateEventTriggerAccess().getGroupAssignment_1(), "rule__GroupMemberUpdateEventTrigger__GroupAssignment_1");
			builder.put(grammarAccess.getGroupMemberUpdateEventTriggerAccess().getStateAssignment_3(), "rule__GroupMemberUpdateEventTrigger__StateAssignment_3");
			builder.put(grammarAccess.getChangedEventTriggerAccess().getItemAssignment_1(), "rule__ChangedEventTrigger__ItemAssignment_1");
			builder.put(grammarAccess.getChangedEventTriggerAccess().getOldStateAssignment_3_1(), "rule__ChangedEventTrigger__OldStateAssignment_3_1");
			builder.put(grammarAccess.getChangedEventTriggerAccess().getNewStateAssignment_4_1(), "rule__ChangedEventTrigger__NewStateAssignment_4_1");
			builder.put(grammarAccess.getGroupMemberChangedEventTriggerAccess().getGroupAssignment_1(), "rule__GroupMemberChangedEventTrigger__GroupAssignment_1");
			builder.put(grammarAccess.getGroupMemberChangedEventTriggerAccess().getOldStateAssignment_3_1(), "rule__GroupMemberChangedEventTrigger__OldStateAssignment_3_1");
			builder.put(grammarAccess.getGroupMemberChangedEventTriggerAccess().getNewStateAssignment_4_1(), "rule__GroupMemberChangedEventTrigger__NewStateAssignment_4_1");
			builder.put(grammarAccess.getEventEmittedTriggerAccess().getChannelAssignment_1(), "rule__EventEmittedTrigger__ChannelAssignment_1");
			builder.put(grammarAccess.getEventEmittedTriggerAccess().getTriggerAssignment_3(), "rule__EventEmittedTrigger__TriggerAssignment_3");
			builder.put(grammarAccess.getTimerTriggerAccess().getCronAssignment_0_2(), "rule__TimerTrigger__CronAssignment_0_2");
			builder.put(grammarAccess.getTimerTriggerAccess().getTimeAssignment_1_2(), "rule__TimerTrigger__TimeAssignment_1_2");
			builder.put(grammarAccess.getThingStateUpdateEventTriggerAccess().getThingAssignment_1(), "rule__ThingStateUpdateEventTrigger__ThingAssignment_1");
			builder.put(grammarAccess.getThingStateUpdateEventTriggerAccess().getStateAssignment_3(), "rule__ThingStateUpdateEventTrigger__StateAssignment_3");
			builder.put(grammarAccess.getThingStateChangedEventTriggerAccess().getThingAssignment_1(), "rule__ThingStateChangedEventTrigger__ThingAssignment_1");
			builder.put(grammarAccess.getThingStateChangedEventTriggerAccess().getOldStateAssignment_3_1(), "rule__ThingStateChangedEventTrigger__OldStateAssignment_3_1");
			builder.put(grammarAccess.getThingStateChangedEventTriggerAccess().getNewStateAssignment_4_1(), "rule__ThingStateChangedEventTrigger__NewStateAssignment_4_1");
			builder.put(grammarAccess.getValidStateIdAccess().getValueAssignment(), "rule__ValidStateId__ValueAssignment");
			builder.put(grammarAccess.getValidStateNumberAccess().getValueAssignment(), "rule__ValidStateNumber__ValueAssignment");
			builder.put(grammarAccess.getValidStateStringAccess().getValueAssignment(), "rule__ValidStateString__ValueAssignment");
			builder.put(grammarAccess.getValidCommandIdAccess().getValueAssignment(), "rule__ValidCommandId__ValueAssignment");
			builder.put(grammarAccess.getValidCommandNumberAccess().getValueAssignment(), "rule__ValidCommandNumber__ValueAssignment");
			builder.put(grammarAccess.getValidCommandStringAccess().getValueAssignment(), "rule__ValidCommandString__ValueAssignment");
			builder.put(grammarAccess.getValidTriggerIdAccess().getValueAssignment(), "rule__ValidTriggerId__ValueAssignment");
			builder.put(grammarAccess.getValidTriggerNumberAccess().getValueAssignment(), "rule__ValidTriggerNumber__ValueAssignment");
			builder.put(grammarAccess.getValidTriggerStringAccess().getValueAssignment(), "rule__ValidTriggerString__ValueAssignment");
			builder.put(grammarAccess.getScriptAccess().getExpressionsAssignment_1_0(), "rule__Script__ExpressionsAssignment_1_0");
			builder.put(grammarAccess.getQuantityLiteralAccess().getValueAssignment_1(), "rule__QuantityLiteral__ValueAssignment_1");
			builder.put(grammarAccess.getQuantityLiteralAccess().getUnitAssignment_3(), "rule__QuantityLiteral__UnitAssignment_3");
			builder.put(grammarAccess.getStringUnitAccess().getValueAssignment(), "rule__StringUnit__ValueAssignment");
			builder.put(grammarAccess.getIDUnitAccess().getValueAssignment(), "rule__IDUnit__ValueAssignment");
			builder.put(grammarAccess.getSpecificUnitAccess().getValueAssignment(), "rule__SpecificUnit__ValueAssignment");
